...
const data = [
  { type: 'AAA', subtype: 'Nombre', modality: 'Nombre', address: 'Dirección', zone: 'Zona', station: 'Direccion', date: '25/08/2022', hour: '19:20' },
  { type: 'AAA', subtype: 'Nombre', modality: 'Nombre', address: 'Dirección', zone: 'Zona', station: 'Direccion', date: '25/08/2022', hour: '19:20' },
  { type: 'AAA', subtype: 'Nombre', modality: 'Nombre', address: 'Dirección', zone: 'Zona', station: 'Direccion', date: '25/08/2022', hour: '19:20' },
  { type: 'AAA', subtype: 'Nombre', modality: 'Nombre', address: 'Dirección', zone: 'Zona', station: 'Direccion', date: '25/08/2022', hour: '19:20' },
  { type: 'AAA', subtype: 'Nombre', modality: 'Nombre', address: 'Dirección', zone: 'Zona', station: 'Direccion', date: '25/08/2022', hour: '19:20' },
      ...
      <>
        <Card className="crimesPage__header">
          ...
          <Button 
            ...
            buttonType="secondary">Subir crímen</Button>
        </Card>
        ...
        <Card className={"addcrimePage"+addcrimePageStatus}>
          <section className="addcrimePage__header">
            ...
            buttonType="secondary">X</Button>
          </section>
          <form className="addcrimePage__content">
            <p className="addcrimePage__content__text">Estación de policía, fecha y hora:</p>
            ...
            <p className="addcrimePage__content__text">Tipo de delito y modalidad</p>
            <InputContainer className="addcrimePage__content__aux">
